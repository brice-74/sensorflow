...
// EvalCalc evaluates a simple arithmetic expression containing +, -, *, /
func EvalCalc[T constraints.Float | constraints.Integer](expr string) (T, error) {
	...
	applyOp := func(a, b T, op rune) (T, error) {
		var res T
		switch op {
		case '+':
			res = a + b
