...
type SensorServiceClient interface {
	StreamMeasurements(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SensorMeasurementsRequest, emptypb.Empty], error)
	UnaryMeasurements(ctx context.Context, in *SensorMeasurementsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *sensorServiceClient) StreamMeasurements(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SensorMeasurementsRequest, emptypb.Empty], error) {
	...
	x := &grpc.GenericClientStream[SensorMeasurementsRequest, emptypb.Empty]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SensorService_StreamMeasurementsClient = grpc.ClientStreamingClient[SensorMeasurementsRequest, emptypb.Empty]

func (c *sensorServiceClient) UnaryMeasurements(ctx context.Context, in *SensorMeasurementsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SensorServiceServer interface {
	StreamMeasurements(grpc.ClientStreamingServer[SensorMeasurementsRequest, emptypb.Empty]) error
	UnaryMeasurements(context.Context, *SensorMeasurementsRequest) (*emptypb.Empty, error)
...
func (UnimplementedSensorServiceServer) StreamMeasurements(grpc.ClientStreamingServer[SensorMeasurementsRequest, emptypb.Empty]) error {
	return status.Errorf(codes.Unimplemented, "method StreamMeasurements not implemented")
}
func (UnimplementedSensorServiceServer) UnaryMeasurements(context.Context, *SensorMeasurementsRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnaryMeasurements not implemented")
}
...
func _SensorService_StreamMeasurements_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SensorServiceServer).StreamMeasurements(&grpc.GenericServerStream[SensorMeasurementsRequest, emptypb.Empty]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SensorService_StreamMeasurementsServer = grpc.ClientStreamingServer[SensorMeasurementsRequest, emptypb.Empty]
