...
func (c *InfluxDB) Define(loader *config.Loader) {
	loader.String(&c.URL, "influxdb_url", "INFLUXDB_URL", "", "influxDB v3 api url").Required()
	loader.String(&c.Token, "influxdb_token", "INFLUXDB_TOKEN", "", "influxDB v3 token access").Required()
	loader.String(&c.Database, "influxdb_database", "INFLUXDB_DATABSE", "", "influxDB v3 database name").Required()
